...
int main(void)
{
  ...
  // AdvanceVisual_AlignDiskCenterBlocking();
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LIFT_UP_LIMIT_Pin LIFT_DOWN_LIMIT_Pin */
  GPIO_InitStruct.Pin = LIFT_UP_LIMIT_Pin|LIFT_DOWN_LIMIT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : SLIDE_FRONT_LIMIT_Pin */
  GPIO_InitStruct.Pin = SLIDE_FRONT_LIMIT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SLIDE_FRONT_LIMIT_GPIO_Port, &GPIO_InitStruct);
